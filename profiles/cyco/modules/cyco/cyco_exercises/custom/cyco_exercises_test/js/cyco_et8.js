(function($) {
  Drupal.behaviors.ext8 = {
    ...
    attach: function(context, settings) {
      ...
      $("#test").click(  
        Drupal.behaviors.ext8.startTest
      );
    },
    startTest: function(){
      Drupal.behaviors.ext8.showAjaxThrobber();
      $.when(
        Drupal.behaviors.ext8.getCsrfToken()
      )
      .then(function() {
        ...
        //Grab and show vocab.
        $.when( 
          Drupal.behaviors.ext8.testUpdate()
        )
        .then(function( result ) {
          console.log("Result: ", result);
          Drupal.behaviors.ext8.hideAjaxThrobber();
        })
        .fail(function() {
    ...
    getCsrfToken: function(){
      ...
      var promise = $.ajax({ 
        ...
        .done(function(token){
          Drupal.behaviors.ext8.token = token;
          return token;
        })
    ...
    testUpdate: function() {
      ...
      var promise = $.ajax({
        ...
        beforeSend: function (request) {
          request.setRequestHeader("X-CSRF-Token", Drupal.behaviors.ext8.token);
        }
      })
