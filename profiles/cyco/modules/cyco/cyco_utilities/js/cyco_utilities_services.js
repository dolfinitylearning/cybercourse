...
var cycoUtilitiesServices = cycoUtilitiesServices || {};
...
(function($) {
  ...
  */
  cycoUtilitiesServices.getCsrfToken = function(){
   ...
   var promise = $.ajax({ 
     ...
     .done(function(token){
       cycoUtilitiesServices.csrfToken = token;
     })
   ...
   */
  cycoUtilitiesServices.makeWaitThrobber = function( idToUse, message, extraClasses ) {
